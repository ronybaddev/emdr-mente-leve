        ...
        <div className="max-w-6xl mx-auto bg-card/90 backdrop-blur-sm rounded-3xl p-8 md:p-12 shadow-xl border border-border">
          ...
          <div className="cta-animate flex flex-col sm:flex-row gap-4 justify-center items-center sm:items-stretch">
            <Button
              ...
              size="lg"
              className="bg-secondary hover:bg-secondary/90 text-white shadow-lg text-lg px-8 py-4 h-14 group"
            >
              Agendar Consulta
            ...
            <a
              ...
              aria-label="Falar no WhatsApp sobre terapia EMDR"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 h-14 rounded-md bg-green-500 hover:bg-green-600 text-white transition-colors font-medium text-lg shadow-lg"
            >
