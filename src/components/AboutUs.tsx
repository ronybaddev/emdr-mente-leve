...
export const AboutUs = () => {
  return <section id="quem-somos" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="grid grid-cols-1 gap-6 animate-fade-in">
            {stats.map((stat, index) => <div key={index} className="bg-gradient-to-br from-primary/10 to-secondary/10 rounded-xl p-6 flex items-center gap-4 shadow-md hover:shadow-lg transition-shadow">
